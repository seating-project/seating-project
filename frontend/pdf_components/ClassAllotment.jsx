...
//         children.push(
//           <tr className="h-16">
//             <td className="border-2 text-center p-5 text-xl w-150 h-32">
...
//           <table className="table-auto border-2 border-black w-full h-full">
//             <thead className="h-16 text-2xl text-center w-150 p-5">
//               <tr>
//                 <th>Row {i + 1}</th>
//               </tr>
//             </thead>
