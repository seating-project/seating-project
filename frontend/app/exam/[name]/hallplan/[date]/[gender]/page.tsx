...
export default async function HallPlanPage({params}: any) {
    ...
    return (
        ...
        {/* <NoticeBoardCopy ranges={rangesCurrent["Main Building"]["EH13"]} exam={exam} date={date} room={"EH13"} logoUrl={logoUrl} /> */}
            <OldNotice gender={gender} building="Main Building" exam={name} date={date} ranges={rangesCurrent} logoUrl={logoUrl as string} bgsep={template.is_boys_girls_separation} strictDivide={exam.strictly_divide_buildings}/>
        </>
    )
}   