  ...
  return (
    <div className="w-auto h-auto bg-white p-4 m-4 rounded-xl shadow-lg hover:box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; transition backdrop-blur-lg flex flex-col justify-between">
      <div className="flex flex-col">
        <p className="font-bold text-4xl p-2 mb-4">{name}</p>
      </div>
      <Link href={`/templates/${name}`}>
      <div
        className="flex flex-row items-center relative text-blue after:content-[''] after:absolute after:w-full 
