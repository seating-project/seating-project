...
const Navbar = () => {
  return (
    <div className="flex p-8 justify-between bg-white shadow-md relative w-full">
      <div className="ml-8 flex justify-between items-center mr-8">
        ...
        <Link href="/" className="flex">
          {/* <Image
            ...
            alt="logo"
          /> */}
          <h1 className=" text-6xl font-mono font-semibold text-[#6666FF] ml-2 items-center border-b-4 border-[#6666FF]">Seats</h1>
        </Link>
        {/* </div> */}
        {/* <hr className="w-full border-black border-1 mt-4" /> */}
        
      </div>
      <div className="flex justify-between items-center relative text-blue after:content-[''] after:absolute after:w-full 
          after:scale-x-0 after:h-[2px] after:bottom-0 after:left-0 after:bg-[#6666FF] after:origin-bottom-right after:transition-transform
