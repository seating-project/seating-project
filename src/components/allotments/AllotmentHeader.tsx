          ...
          <TableRow>
            ...
            <TableCell className="border ">
              <div className="flex">
                ...
                <p>{(startTime?.getUTCHours() as number) > 12 ? "PM" : "AM"}</p>
              </div>
            </TableCell>
            <TableCell className="border">
              <div className="flex">
                ...
                <p>
                  {(startTime?.getUTCHours() as number) > 12
                    ? (startTime?.getUTCHours() as number) - 12
                    : startTime?.getUTCHours()}
                  {startTime?.getUTCMinutes() !== 0 &&
                    ":" + String(startTime?.getUTCMinutes())}
                  {(startTime?.getUTCHours() as number) > 12 ? " PM" : " AM"} -{" "}
                  {(endTime?.getUTCHours() as number) > 12
                    ? (endTime?.getUTCHours() as number) - 12
                    : endTime?.getUTCHours()}
                  {endTime?.getUTCMinutes() !== 0 &&
                    ":" + String(endTime?.getUTCMinutes())}
                  {(endTime?.getUTCHours() as number) > 12 ? " PM" : " AM"}
                </p>
              </div>
            </TableCell>
          </TableRow>
