...
import type {  StudentAllotments, Students } from "@/types";
...
type Props = {
  ...
  date: string;
  students: Students
  allotments: StudentAllotments | null;
};

const AllotmentTable = ({ exam, template, roomsOrder, date, students, allotments }: Props) => {
